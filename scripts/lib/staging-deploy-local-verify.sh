...
build_staging_verify_state_env_cmd() {
    cat <<EOF
$(remote_assignment STATE_DIR "$STATE_DIR")$(remote_assignment APP_DIR "$APP_DIR")$(remote_assignment STAGING_VERIFIED_AT "${STAGING_VERIFIED_AT:-}")$(remote_assignment STAGING_EMAIL_PREFLIGHT_MODE "${CP_EMAIL_PREFLIGHT_MODE:-required}")$(remote_assignment STAGING_EMAIL_DELIVERY_HIGH_RISK "${STAGING_EMAIL_DELIVERY_HIGH_RISK:-unknown}")$(remote_assignment STAGING_EMAIL_PREFLIGHT_RESULT "${STAGING_EMAIL_PREFLIGHT_RESULT:-unknown}")$(remote_assignment STAGING_EMAIL_PREFLIGHT_PROVIDER "${STAGING_EMAIL_PREFLIGHT_PROVIDER:-unknown}")$(remote_assignment STAGING_WINDOWS_FIREFOX_HIGH_RISK "${STAGING_WINDOWS_FIREFOX_HIGH_RISK:-unknown}")$(remote_assignment STAGING_SMOKE_RESULT "${STAGING_SMOKE_RESULT:-}")$(remote_assignment STAGING_SMOKE_STATUS "${STAGING_SMOKE_STATUS:-}")$(remote_assignment STAGING_RELEASE_GATE_RESULT "${STAGING_RELEASE_GATE_RESULT:-}")$(remote_assignment STAGING_ENROLLMENT_DOWNLOAD_RESULT "${STAGING_ENROLLMENT_DOWNLOAD_RESULT:-}")$(remote_assignment STAGING_LINUX_ENROLLMENT_SCRIPT_RESULT "${STAGING_LINUX_ENROLLMENT_SCRIPT_RESULT:-}")$(remote_assignment STAGING_WINDOWS_ENROLLMENT_SCRIPT_RESULT "${STAGING_WINDOWS_ENROLLMENT_SCRIPT_RESULT:-}")$(remote_assignment STAGING_FIREFOX_RELEASE_ARTIFACTS "${STAGING_FIREFOX_RELEASE_ARTIFACTS:-}")$(remote_assignment STAGING_WINDOWS_BOOTSTRAP_RESULT "${STAGING_WINDOWS_BOOTSTRAP_RESULT:-}")$(remote_assignment STAGING_FIREFOX_POLICY_RESULT "${STAGING_FIREFOX_POLICY_RESULT:-}")$(remote_assignment STAGING_WINDOWS_BOOTSTRAP_CANARY_RESULT "${STAGING_WINDOWS_BOOTSTRAP_CANARY_RESULT:-}")$(remote_assignment STAGING_WINDOWS_BOOTSTRAP_CANARY_APP_SHA "${STAGING_WINDOWS_BOOTSTRAP_CANARY_APP_SHA:-}")$(remote_assignment STAGING_WINDOWS_BOOTSTRAP_CANARY_RUN_ID "${STAGING_WINDOWS_BOOTSTRAP_CANARY_RUN_ID:-}")$(remote_assignment STAGING_WINDOWS_BOOTSTRAP_CANARY_FAILURE_BOUNDARY_ID "${STAGING_WINDOWS_BOOTSTRAP_CANARY_FAILURE_BOUNDARY_ID:-}")$(remote_assignment STAGING_WINDOWS_BOOTSTRAP_CANARY_FAILURE_BOUNDARY_MESSAGE "${STAGING_WINDOWS_BOOTSTRAP_CANARY_FAILURE_BOUNDARY_MESSAGE:-}")$(remote_assignment STAGING_FIREFOX_EXTENSION_ID "${STAGING_FIREFOX_EXTENSION_ID:-}")$(remote_assignment STAGING_FIREFOX_RELEASE_VERSION "${STAGING_FIREFOX_RELEASE_VERSION:-}")$(remote_assignment STAGING_FIREFOX_SIGNATURE_SOURCE "${STAGING_FIREFOX_SIGNATURE_SOURCE:-}")$(remote_assignment STAGING_FIREFOX_SIGNATURE_STATE "${STAGING_FIREFOX_SIGNATURE_STATE:-}")$(remote_assignment STAGING_FIREFOX_METADATA_SHA256 "${STAGING_FIREFOX_METADATA_SHA256:-}")$(remote_assignment STAGING_FIREFOX_XPI_SHA256 "${STAGING_FIREFOX_XPI_SHA256:-}")$(remote_assignment STAGING_LINUX_BOOTSTRAP_RESULT "${STAGING_LINUX_BOOTSTRAP_RESULT:-}")$(remote_assignment STAGING_LINUX_BOOTSTRAP_RUN_ID "${STAGING_LINUX_BOOTSTRAP_RUN_ID:-}")$(remote_assignment STAGING_LINUX_BOOTSTRAP_FAILURE_BOUNDARY_ID "${STAGING_LINUX_BOOTSTRAP_FAILURE_BOUNDARY_ID:-}")$(remote_assignment STAGING_LINUX_BOOTSTRAP_FAILURE_BOUNDARY_MESSAGE "${STAGING_LINUX_BOOTSTRAP_FAILURE_BOUNDARY_MESSAGE:-}")
EOF
}
