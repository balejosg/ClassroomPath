...
reset_staging_verification_env() {
  ...
  STAGING_WINDOWS_BOOTSTRAP_CANARY_RESULT="${STAGING_WINDOWS_BOOTSTRAP_CANARY_RESULT:-}"
  STAGING_WINDOWS_BOOTSTRAP_CANARY_APP_SHA="${STAGING_WINDOWS_BOOTSTRAP_CANARY_APP_SHA:-}"
  STAGING_WINDOWS_BOOTSTRAP_CANARY_RUN_ID="${STAGING_WINDOWS_BOOTSTRAP_CANARY_RUN_ID:-}"
  STAGING_WINDOWS_BOOTSTRAP_CANARY_FAILURE_BOUNDARY_ID="${STAGING_WINDOWS_BOOTSTRAP_CANARY_FAILURE_BOUNDARY_ID:-}"
  STAGING_WINDOWS_BOOTSTRAP_CANARY_FAILURE_BOUNDARY_MESSAGE="${STAGING_WINDOWS_BOOTSTRAP_CANARY_FAILURE_BOUNDARY_MESSAGE:-}"
