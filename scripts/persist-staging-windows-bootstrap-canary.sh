...
remote_env_cmd="$(
  ...
  remote_assignment INPUT_STAGING_WINDOWS_BOOTSTRAP_CANARY_RESULT "$STAGING_WINDOWS_BOOTSTRAP_CANARY_RESULT"
  remote_assignment INPUT_STAGING_WINDOWS_BOOTSTRAP_CANARY_APP_SHA "$STAGING_WINDOWS_BOOTSTRAP_CANARY_APP_SHA"
  remote_assignment INPUT_STAGING_WINDOWS_BOOTSTRAP_CANARY_RUN_ID "$STAGING_WINDOWS_BOOTSTRAP_CANARY_RUN_ID"
  remote_assignment INPUT_STAGING_WINDOWS_BOOTSTRAP_CANARY_FAILURE_BOUNDARY_ID "$STAGING_WINDOWS_BOOTSTRAP_CANARY_FAILURE_BOUNDARY_ID"
  remote_assignment INPUT_STAGING_WINDOWS_BOOTSTRAP_CANARY_FAILURE_BOUNDARY_MESSAGE "$STAGING_WINDOWS_BOOTSTRAP_CANARY_FAILURE_BOUNDARY_MESSAGE"
)"
...
STAGING_WINDOWS_BOOTSTRAP_CANARY_APP_SHA="$INPUT_STAGING_WINDOWS_BOOTSTRAP_CANARY_APP_SHA"
STAGING_WINDOWS_BOOTSTRAP_CANARY_RUN_ID="$INPUT_STAGING_WINDOWS_BOOTSTRAP_CANARY_RUN_ID"
STAGING_WINDOWS_BOOTSTRAP_CANARY_FAILURE_BOUNDARY_ID="$INPUT_STAGING_WINDOWS_BOOTSTRAP_CANARY_FAILURE_BOUNDARY_ID"
STAGING_WINDOWS_BOOTSTRAP_CANARY_FAILURE_BOUNDARY_MESSAGE="$INPUT_STAGING_WINDOWS_BOOTSTRAP_CANARY_FAILURE_BOUNDARY_MESSAGE"
