...
function expectedRuntimeFromEnv(env) {
  return {
    EXPECTED_RELEASE_ID: env.EXPECTED_RELEASE_ID,
    EXPECTED_RC_RUN_ID: env.EXPECTED_RC_RUN_ID,
    EXPECTED_APP_SHA: env.EXPECTED_APP_SHA,
    EXPECTED_OPENPATH_SHA: env.EXPECTED_OPENPATH_SHA,
    EXPECTED_OPENPATH_CONTRACT_SHA256: env.EXPECTED_OPENPATH_CONTRACT_SHA256,
    ...
    EXPECTED_OPENPATH_LINUX_AGENT_APT_SUITE: env.EXPECTED_OPENPATH_LINUX_AGENT_APT_SUITE,
    EXPECTED_SPA_IMAGE: env.EXPECTED_SPA_IMAGE,
    EXPECTED_VERIFIER_IMAGE: env.EXPECTED_VERIFIER_IMAGE,
