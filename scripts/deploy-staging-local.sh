...
REMOTE_ENV_CMD="$(
    ...
    remote_assignment STAGING_RELEASE_RUN_ID "$STAGING_RELEASE_RUN_ID"
    remote_assignment STAGING_RELEASE_REPOSITORY "$STAGING_RELEASE_REPOSITORY"
    ...
    remote_assignment STRIPE_ANNUAL_PRICE_1_10 "${STRIPE_ANNUAL_PRICE_1_10:-}"
    remote_assignment STRIPE_ANNUAL_PRICE_11_25 "${STRIPE_ANNUAL_PRICE_11_25:-}"
    remote_assignment STRIPE_ANNUAL_PRICE_26_50 "${STRIPE_ANNUAL_PRICE_26_50:-}"
    remote_assignment STRIPE_ANNUAL_PRICE_51_100 "${STRIPE_ANNUAL_PRICE_51_100:-}"
    remote_assignment STRIPE_ONBOARDING_PRICE_1_25 "${STRIPE_ONBOARDING_PRICE_1_25:-}"
    remote_assignment STRIPE_ONBOARDING_PRICE_26_100 "${STRIPE_ONBOARDING_PRICE_26_100:-}"
    remote_assignment STRIPE_PILOT_PRICE "${STRIPE_PILOT_PRICE:-}"
)"
