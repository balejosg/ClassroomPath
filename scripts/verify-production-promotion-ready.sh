...
PRODUCTION_DEPLOY_ROOT="$CLASSROOMPATH_DEPLOY_ROOT"
...
export EXPECTED_CP_OFFLINE_INSTALLER_TEMPLATE_VERSION="$CP_OFFLINE_INSTALLER_TEMPLATE_VERSION"
export EXPECTED_CP_OFFLINE_INSTALLER_TEMPLATE_COMMIT="$CP_OFFLINE_INSTALLER_TEMPLATE_COMMIT"
export EXPECTED_CP_OFFLINE_INSTALLER_TEMPLATE_RELEASE_TAG="$CP_OFFLINE_INSTALLER_TEMPLATE_RELEASE_TAG"
export EXPECTED_CP_OFFLINE_INSTALLER_TEMPLATE_SHA256="$CP_OFFLINE_INSTALLER_TEMPLATE_SHA256"
