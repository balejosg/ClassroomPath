...
import { initModals, showScreen, openModal, closeModal, initTheme, toggleTheme, initSidebar } from '@/modules/ui.js';
import { navigateToScreen, updateIcons } from './ui-extensions.js';
