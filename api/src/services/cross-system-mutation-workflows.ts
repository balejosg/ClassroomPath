import type { MutationOperationRecord } from '../lib/cross-system-mutations.js';
...
export const organizationMutationRetryHandlers: Record<string, RetryHandler> = {
...
export function getOrganizationMutationRetryHandler(
  ...
  return organizationMutationRetryHandlers[operationType];
}
