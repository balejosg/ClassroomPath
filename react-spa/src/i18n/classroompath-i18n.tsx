...
const classroomPathI18nEn = {
  ...
  'admin.pendingUsersBanner': '{count} user{plural} waiting for approval',
  'admin.review': 'Review',
  'admin.accessRequests': 'Access Requests',
  'admin.pendingUsersSummary': '{count} pending user{plural}',
  ...
  'pendingUsers.summary': '{count} pending request{plural}',
...
const classroomPathI18nEs: Record<ClassroomPathI18nKey, string> = {
  ...
  'platform.entitlements': 'Entitlements activos y recientes',
  'platform.loadingSchools': 'Cargando centros...',
  'platform.noEntitlements': 'Aún no hay entitlements registradas.',
  ...
  'admin.pendingUsersBanner': '{count} usuario{plural} esperando aprobación',
  'admin.review': 'Revisar',
  'admin.accessRequests': 'Solicitudes de acceso',
  'admin.pendingUsersSummary': '{count} usuario{plural} pendiente{plural}',
  ...
  'pendingUsers.summary': '{count} solicitud{plural} pendiente{plural}',
